                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Opacity(
                          opacity: 0.7,
                          child: Text(
                            'Apply to get verified as a restaurant',
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelMedium,
                                        hintText: 'Adress on Google Maps',
                                        hintStyle: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Readex Pro',
                                ...
                                Text(
                                  'Hereby, according to Terms & Conditions established by Savely, by applying to become a restaurant owner, I comply with the condition that to all the products my restaurant will list on the platform will be applied automatically 67 % discount from the original price.',
                                  style:
                                      FlutterFlowTheme.of(context).bodyMedium,
                                ),
                              ],
